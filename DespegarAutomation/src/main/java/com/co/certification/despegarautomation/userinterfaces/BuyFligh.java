...
public class BuyFligh {
	public static final Target BUTTON_BUY = Target.the("Button buy").located(By.xpath("(//*[@class = 'eva-3-cluster-basic -eva-3-shadow-line-hover']//*[@class='-md eva-3-btn -primary'])[1]"));
